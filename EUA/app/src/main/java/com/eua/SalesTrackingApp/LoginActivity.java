 ...
 */
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, LoggedAsFragment.OnFragmentInteractionListener {
    ...
    private void showEditDialog(String string) {
        LoggedAsFragment editNameDialog = LoggedAsFragment.newInstance(string);
        editNameDialog.show(getSupportFragmentManager(), "loggedAs");
    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                Toast.makeText(getApplicationContext(), "No estás conectado a Internet. Intenta nuevamente.", Toast.LENGTH_LONG).show();
            }
        }
